...
在这场史诗般的旅程中，你将不仅仅是学习一门新的语言，更是要亲手重现数学史上最璀璨的明珠之一的之一——费马大定理（n=4情况）的证明。

我们将从 Lean 的最基本操作开始，一步步为你装备强大的数论工具和逻辑策略。你将揭开勾股数的秘密，掌握“无穷递降法”这门古老的证明艺术，并最终集结所有智慧，向费马的终极挑战发起冲击。
...
Dependency W01_Foundation → W03_NumberTheoryArmory

Dependency W02_PythagoreanTriples → W04_InfiniteDescent
